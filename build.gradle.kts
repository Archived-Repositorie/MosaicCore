...
dependencies {
    ...
    mappings("net.fabricmc:yarn:${project.properties["minecraft_version"]}+${project.properties["yarn_mappings"]}:v2")
    modImplementation("net.fabricmc:fabric-loader:${project.properties["loader_version"]}")
    modImplementation("net.fabricmc:fabric-language-kotlin:${project.properties["fabric_kotlin_version"]}.${project.properties["kotlin_version"]}")
